...
class Game():
    ...
    def start_game(self):
        ...
        if self.save_step_player == self.save_step_pc:
            return 'Ничья!\n'
        elif (self.save_step_player == 'r' and self.save_step_pc == 's') or (
                self.save_step_player == 's' and self.save_step_pc == 'p') or (
                self.save_step_player == 'p' and self.save_step_pc == 'r'):
            return 'Вы выиграли! \n'
        else:
            return 'Вы проиграли!\n'
